...
| Domaine | Années 1980 | Aujourd'hui |
|---|---|---|
| Compresseur | Puissance fixe, calé sur un point de fonctionnement | Vitesse variable (onduleur) — s'adapte en continu à la charge et à la température |
| Fluide frigorigène | R22, R502 — peu optimisés pour le froid extrême | R410A, R32, R290 (propane) — meilleurs échanges thermiques à basse température |
| Évaporateur | Dimensionné pour +5 °C à +10 °C | Surfaces augmentées, géométries optimisées pour −20 °C |
| Dégivrage | Cycles fixes, énergivores | Dégivrage à la demande, par inversion de cycle ou par injection de gaz chaud |
| Régulation | Tout ou rien (marche/arrêt) | Électronique de puissance, régulation en continu, courbes climatiques |
| Architecture | Souvent monobloc, non adaptable | Bi-bloc, réversible, modulable selon le besoin |
